...
urlpatterns = [
    ...
    path('ratings/update/<int:coach_id>/<int:rating_id>/', views.update_rating, name='update_rating'),
    ...
    path('verification/<int:verification_id>/', views.get_verification, name='get_verification'),
